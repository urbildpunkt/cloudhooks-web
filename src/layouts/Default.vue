<template>
  <div class="font-sans antialiased text-ui-typo bg-ui-background">
    <div class="flex flex-col justify-start min-h-screen">
      ...
      <header
        ref="header"
        class="sticky top-0 z-10 w-full border-b-2 bg-ui-background border-ui-border"
      ...
      <footer class="border-t-2 border-ui-border">
        <div class="container">
          <p class="my-8 flex justify-between text-gray-600">
          <span>&copy; cloudhooks</span>
          <span>
            <g-link to="/docs/terms" class="hover:underline">Terms</g-link>
            <span class="mx-2 text-gray-600">&middot;</span>
            <g-link to="/docs/privacy" class="hover:underline">Privacy</g-link>
          </span>
          </p>
        </div>
      </footer>
